...
p_trend
ggsave("linear_change_of_cost_region.jpg", width = 4, height = 4)
...
ggsave("change_of_cost_per_insured_region.jpg", width = 4, height = 4)
...
ggsave("linear_change_of_cost_per_insured_region.jpg", width = 4, height = 4)
